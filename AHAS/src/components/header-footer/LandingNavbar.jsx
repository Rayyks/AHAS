...
const LandingNavbar = () => {
  ...
  return (
    <header
      className={`fixed z-50 left-0 right-0 mx-auto bg-white dark:bg-[#363636] transition-all duration-300  ${
        visible ? "h-16 shadow-lg" : "h-0 -top-14 shadow-none"
      }`}
    >
      ...
      {isMobileMenuOpen && (
        <div className="md:hidden">
          <nav className="px-4 pb-4 bg-white dark:bg-[#363636]">
            <ul className="flex flex-col gap-4 text-sm">
              ...
              <li>
                <Link
                  className="block rounded-md bg-teal-600 px-5 py-2.5 text-sm font-medium text-white shadow dark:hover:bg-teal-500"
                  to={isAuth ? "/dashboard" : "/login"}
                  onClick={() => setIsMobileMenuOpen(false)}
                >
                  {isAuth ? "Dashboard" : "Login"}
